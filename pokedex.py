#takes all the raw data of the pokemon and converts it into a dict of Pokemon classes



import pickle #library used to serialize and save the dictionary of classes
test_dict= {}
mons = [
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Insect Plate", "Buginium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceusdark:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Dread Plate", "Darkinium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceusdragon:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Draco Plate", "Dragonium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceuselectric:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Zap Plate", "Electrium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceusfairy:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Pixie Plate", "Fairium Z"],
	# 	"changesfrom": "Arceus",
	# 	"gen": 6,
	# },
	# arceusfighting:= {
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Fist Plate", "Fightinium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceusfire:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Flame Plate", "Firium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceusflying:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Sky Plate", "Flyinium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceusghost:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Spooky Plate", "Ghostium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceusgrass:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Meadow Plate", "Grassium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceusground:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Earth Plate", "Groundium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceusice:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Icicle Plate", "Icium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceuspoison:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Toxic Plate", "Poisonium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceuspsychic:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Mind Plate", "Psychium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceusrock:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Stone Plate", "Rockium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceussteel:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Iron Plate", "Steelium Z"],
	# 	"changesfrom": "Arceus",
	# },
	# arceuswater:= {
	# 	"num": 493,
	...
	# 	"color": "White",
	# 	"eggGroups": ["Undiscovered"],
	# 	"requitedItems": ["Splash Plate", "Waterium Z"],
	# 	"changesfrom": "Arceus",
	# }
	]

with open('movesets_data.pickle', 'rb') as file:
   learnset_data = pickle.load(file)


class Pokemon:
    #class that makes the pokemon with their stats and typing
	def __init__(mon, name, type1, type2, health, atk, defence, spatk, spdef, spd, learnsets):
...
# alcremie = Pokemon("Alcremie", "Fairy","none", 240, 125, 155, 225, 247, 133)


# x = Pokemon(mons[0]['name'],mons[0]['types'][0],mons[0]['types'][1],mons[0]['baseStats']['hp'],mons[0]['baseStats']['atk'],
#             mons[0]['baseStats']['def'],mons[0]['baseStats']['spa'],mons[0]['baseStats']['spd'],mons[0]['baseStats']['spe'])
mons2 = []
table = {45 : None, 39:None, 46: None, 32: None}
count =0
def make_mon(mon):
	try: #checks for a second type
		type2 = mon['types'][1]
		x = Pokemon(mon['name'],mon['types'][0],type2,2*mon['baseStats']['hp']+110,2*mon['baseStats']['atk']+5,2*mon['baseStats']['def']+5
				,2*mon['baseStats']['spa']+5,2*mon['baseStats']['spd']+5,2*mon['baseStats']['spe']+5,learnset_data[mon['name'].lower().translate(table)])
	except: #if no second type exists type2 is 'none' for the damage calculations
		type2= 'none'
		x = Pokemon(mon['name'],mon['types'][0],type2,2*mon['baseStats']['hp']+110,2*mon['baseStats']['atk']+5,2*mon['baseStats']['def']+5
				,2*mon['baseStats']['spa']+5,2*mon['baseStats']['spd']+5,2*mon['baseStats']['spe']+5,learnset_data[mon['name'].lower().translate(table)])
	return(x)	
...
for mon in mons:
	try:
		if mon['Forme'] in ["Mega","Gmax","Alola","Galar","Hisui"]: #checks for forms gen 4 doesn't have
			pass
		else:
			x = make_mon(mon)
			test_dict[x.name.lower().translate(table)] = x

	except:
		x = make_mon(mon)
		test_dict[x.name.lower().translate(table)] = x
		
#tested with json but json can't store custom python classes by default
# json.dump(test_dict, open("data.json",'w'), indent=4,default=lambda x: x.__dict__)


print(test_dict['bulbasaur'].learn)
# print(mons[0]['forme'])

with open('data.pickle', 'wb') as file: #pickle, unlike json, can store python class objects by default
