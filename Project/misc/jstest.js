...
for (mon in data) {
    // console.log(mon, data[mon]['learnset'])
    movesets[mon] = []
    for (move in data[mon]['learnset']){
        for(gen in data[mon]['learnset'][move]){
            if (gen.includes('4')){
                movesets[mon].push(move)
            }
        }
        // if (data[mon]['learnset'][move].includes('4M')){
        //     // console.log(move)
        //     movesets[mon].push(move)
        // }
        if (data[mon]['learnset'][move].includes('3T')){
            movesets[mon].push(move)
        }
        }
    }
...
const ingen = (move) => data[mon]['learnset'][move].includes
