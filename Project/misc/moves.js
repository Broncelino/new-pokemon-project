...
const moves2 = {}
for (move in moves){
	if (moves[move]['num'] < 468){
		moves2[move] = moves[move]
	}
}

// console.log(moves2['doubleedge']['recoil'])

// console.log(moves2)
const moves3 = {}
for (move in moves2){
    if (moves2[move]['category'] == 'Special' || moves2[move]['category'] == 'Physical'){
        // console.log(moves2[move])
        moves3[move] = [moves2[move]['name'],moves2[move]['basePower'],moves2[move]['type'],
        moves2[move]['accuracy'],moves2[move]['category'],moves2[move]['self'],moves2[move]['secondary'],moves2[move]['priority'],moves2[move]['recoil'],moves2['target']]
    }
    else {
        moves3[move] = [moves2[move]['name'],moves2[move]['basePower'],moves2[move]['type'],
        moves2[move]['accuracy'],moves2[move]['category'],moves2[move]['status'],moves2[move]['boosts'],moves2[move]['priority'],moves2[move]['recoil'],moves2[move]['target']]
    }
}
for (move in moves3){
    if (moves3[move][4]=='Status'){
        console.log(moves3[move])
    }
    
}
// console.log(moves3)
var fs = require('fs');
fs.writeFile("move.json", JSON.stringify(moves3), function(err) {
    if (err) {
        console.log(err);
    }
});